...
public static class Uwuifier {
	public class Settings {
		public float periodToExclamationChance = 0.9f;
		public float stutterChance = 0.4f;
		public float presuffixChance = 0.3f;
		public float suffixChance = 0.7f;
		public float duplicateCharactersChance = 0.6f;
